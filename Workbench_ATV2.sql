...
SELECT Quantity FROM OrderDetails ORDER BY Quantity DESC, OrderDetailID LIMIT 8;
...
SELECT Quantity FROM OrderDetails ORDER BY Quantity DESC, OrderID LIMIT 9;
...
-- 21. Selecionar os 8 maiores valores de Quantity, ordenados por OrderDetailID. (Repetida)
SELECT Quantity FROM OrderDetails ORDER BY Quantity DESC, OrderDetailID LIMIT 8;
...
SELECT OrderID FROM OrderDetails ORDER BY OrderID ASC, ProductID LIMIT 12;
...
SELECT Quantity FROM OrderDetails ORDER BY Quantity DESC, ProductID LIMIT 6;
...
SELECT ProductID FROM OrderDetails ORDER BY ProductID ASC, OrderID LIMIT 2;
...
SELECT OrderID FROM OrderDetails ORDER BY OrderID DESC, OrderDetailID LIMIT 4;
...
SELECT ProductID FROM OrderDetails ORDER BY ProductID ASC, OrderID LIMIT 5;

-- 40. Selecionar os 6 maiores valores de OrderDetailID, ordenados por Quantity.
SELECT OrderDetailID FROM OrderDetails ORDER BY OrderDetailID DESC, Quantity LIMIT 6;
...
SELECT Quantity FROM OrderDetails ORDER BY Quantity DESC, OrderDetailID LIMIT 12;
...
SELECT OrderID FROM OrderDetails ORDER BY OrderID ASC, ProductID LIMIT 5;
...
SELECT ProductID FROM OrderDetails ORDER BY ProductID DESC, Quantity LIMIT 10;